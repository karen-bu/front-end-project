...
const $distanceInputErrorString = document.querySelector('#distance-input-error-string');
const $distanceInputErrorInteger = document.querySelector('#distance-input-error-integer');
const $distanceInputErrorValue = document.querySelector('#distance-input-error-value');
...
let apiURL = '';
const $summaryPageGetSuggestionsButton = document.querySelector('#get-suggestions');
const $summaryPageRetakeQuizButton = document.querySelector('#summary-retake-quiz');
...
// SUGGESTIONS PAGE
const $suggestionsPageRetakeQuizButton = document.querySelector('#suggestions-retake-quiz');
